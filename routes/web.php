...
Route::get('jadwal/instruktur/index', [InstrukturController::class, 'jadwalPertemuan'])->name('instrukturJadwalIndex');
...
Route::get('/dataTes/cetak', 'reportController@dataTes')->name('dataTesCetak');
Route::get('/intruktur/mapel/index', [mapelController::class, 'instrukturIndex'])->name('instrukturMapelIndex');

Route::get('/pertemuan/filter-absensi', [PertemuanController::class, 'filterAbsensi'])->name('pertemuanFilterAbsensi');