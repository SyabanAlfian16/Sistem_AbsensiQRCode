...
<head>
	...
	<title>Aplikasi Presensi Siswa SMP 2 Pasundan Bandung</title>
		...
		<header class="header">
			<div class="logo-container">
				<a href="../2.2.0" class="logo">
					<img src="{{asset('admin/img/smp.png')}}" width="40" height="35" alt="Porto Admin" />
				</a>
				<p class="logo pt-1	">
					<b>Aplikasi Presensi Siswa SMP 2 Pasundan Bandung</b>
				</p>
			...
			<div class="header-right">
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						...
						<img src="{{ asset('images/user/' . (Auth::user()->foto ?? 'default.jpg')) }}" alt="{{ Auth::user()->nama ?? 'User' }}" class="rounded-circle" width="40px" height="40px" data-lock-picture="img/!logged-user.jpg">
						</figure>
						<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
							<span class="name">{{ Auth::check() ? Auth::user()->nama : 'Guest' }}</span>
					...
					<div class="nano-content">
						<nav id="menu" class="nav-main" role="navigation">
							...
							<ul class="nav nav-main">
								...
								<li>
									<a class="nav-link" href="{{ route('instrukturJadwalIndex') }}">
